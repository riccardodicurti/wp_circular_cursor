...
add_action( 'admin_enqueue_scripts', 'rdc_wcc_enqueue_admin_dependencies' );
 ...
 function rdc_wcc_settings_init() {
  ...
  add_settings_section( 'rdc_wcc_section_developers', __( '', 'rdc_wcc' ), 'rdc_wcc_section_developers_cb', 'rdc_wcc' );
	add_settings_field( 'rdc_wcc_field_cursore', __( 'Disattivare il cursore di base ?', 'rdc_wcc' ), 'rdc_wcc_field_cursore', 'rdc_wcc', 'rdc_wcc_section_developers', [ 'label_for' => 'rdc_wcc_field_cursore', 'class' => 'rdc_wcc_row', 'rdc_wcc_custom_data' => 'custom', ] );
	add_settings_field( 'rdc_wcc_field_numero_di_palline', __( 'Numero di palline', 'rdc_wcc' ), 'rdc_wcc_field_numero_di_palline', 'rdc_wcc', 'rdc_wcc_section_developers', [ 'label_for' => 'rdc_wcc_field_numero_di_palline', 'class' => 'rdc_wcc_row', 'rdc_wcc_custom_data' => 'custom', ] );
	add_settings_field( 'rdc_wcc_field_prima_pallina', __( 'Prima pallina', 'rdc_wcc' ), 'rdc_wcc_field_prima_pallina', 'rdc_wcc', 'rdc_wcc_section_developers', [ 'label_for' => 'rdc_wcc_field_prima_pallina', 'class' => 'rdc_wcc_row', 'rdc_wcc_custom_data' => 'custom', ] );
	add_settings_field( 'rdc_wcc_field_seconda_pallina', __( 'Seconda pallina', 'rdc_wcc' ), 'rdc_wcc_field_seconda_pallina', 'rdc_wcc', 'rdc_wcc_section_developers', [ 'label_for' => 'rdc_wcc_field_seconda_pallina', 'class' => 'rdc_wcc_row', 'rdc_wcc_custom_data' => 'custom', ] );
 }
 ...
 function rdc_wcc_field_prima_pallina( $args ) {
	...
	echo '<input type="number" class="dim_prima_pallina" name="rdc_wcc_options[dim_prima_pallina]" min="1" max="20" step="1" value="' . $rdc_wcc_options['dim_prima_pallina'] . '"/>';
 }

 function rdc_wcc_field_seconda_pallina( $args ) {
	$rdc_wcc_options = get_option( 'rdc_wcc_options' );
	...
	echo '<input type="number" class="dim_seconda_pallina" name="rdc_wcc_options[dim_seconda_pallina]" min="1" max="20" step="1" value="' . $rdc_wcc_options['dim_seconda_pallina'] . '"/>';
	echo '<input type="number" class="vel_seconda_pallina" name="rdc_wcc_options[vel_seconda_pallina]" min="50" max="800" step="50" value="' . $rdc_wcc_options['vel_seconda_pallina'] . '"/>';
 }
